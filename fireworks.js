...
const helpContent = {
  shellType: {
    header: "รูปแบบ",
    body: 'จุดรูปแบบของดอกไม้ไฟทั้งหมด',
  },
  shellSize: {
    header: "ขนาด",
    body: "ขนาดของดอกไม้ไฟหากปรับสูงอาจกระตุกได้",
  },
  quality: {
    header: "ความละเอียด",
    body: "ความลื่นไหลและความชัด",
  },
  skyLighting: {
    header: "แสงสว่าง",
    body: "หลังจากพุระเบิดจะเกิดแสงบนท้องฟ้า",
  },
  scaleFactor: {
    header: "ขนาดของจอ",
    body: "ขนาดมาตรส่วนของหน้าจอที่เล่นอยู่",
  },
  autoLaunch: {
    header: "จุดอัตโนมัติ",
    body: "ปล่อยดอกไม้ไฟเองโดยอัตโนมัติโดยไม่ต้องคลิก",
  },
  finaleMode: {
    header: "จุดเป็นชุด",
    body: "ปล่อยดอกไม้ไฟเป็นกลุ่มจำเป็นต้องเปิดโหมดจุดอัตโนมัตควบคู่ไปด้วย",
  },
  hideControls: {
    header: "ซ่อนเมนู",
    body: "ซ่อนเมนูทั้งหมดที่แสดงบนขอบจอ คลิกที่จอเพื่อแสดงอีกครั้ง",
  },
  fullscreen: {
    header: "เต็มจอ",
    body: "ปรับเป็นโหมดเต็มหน้าจอ",
  },
  longExposure: {
    header: "เปิดชัตเตอร์",
    body: "ทำให้เส้นรูปแบบของดอกไม้ไฟที่แตกออกไม่หายไป",
  },
};
